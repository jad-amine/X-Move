...
| Categories                                                     | Fitness Sports                                                         | Entertainments                                                         |
| -------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| <img src="readme/mobile/home1.png" width="250" height="500" /> | <img src="readme/mobile/FitnessSports.png" width="250" height="500" /> | <img src="readme/mobile/entertainment.png" width="250" height="500" /> |

<br><br>

| Category Specific Players                                        |
| ---------------------------------------------------------------- |
| <img src="readme/mobile/Players.png" width="250" height="500" /> |
...
2. Navigate into the Desktop application folder named <span style="color:#ff4d00">X-Move-electron</span> , to install npm packages:
...
3. Navigate into the Web application folder named <span style="color:#ff4d00">X-Move-react</span> , to install npm packages:
...
4. Navigate into the Mobile application folder named <span style="color:#ff4d00">X-Move-reactnative</span> , to install npm packages:
...
5. Navigate into the node.js server folder named <span style="color:#ff4d00">X-Move-server</span> , to install npm packages:
...
7. Create a Google Firebase account for free, add a new project and initiate a <span style="color:#ff4d00">Firestore</span> instance. Get the project credentials and navigate into x-move-reactnative folder and replace Firebase API key and credentials in the directory .env file with the ones provided by Firebase

8. In the frontend folders (Electron, React, ReactNative) you will find an api.js file holding the baseURL containing the IPv4 address of the server for sending http requests. Check your device <span style="color:#ff4d00"> IPv4</span> local address and change accordingly. Then navigate to x-move-server/app.js and add that address as shown below:

```sh
app.listen(process.env.PORT, "your_device_IPv4", () => ...)
```

9. To run the server, navigate to the X-Move-server folder then run:

```sh
nodemon
```

10. To launch the mobile application on an emulator, make sure you have downloaded one Android Studio AVG device and started it. Then navigate to the <span style="color:#ff4d00">x-move-reactnative</span> folder then run:

```sh
npm start
```

when Metro finishes building press a to preview on Android device or w on the web

11. To launch the web application navigate to the <span style="color:#ff4d00">x-move-react</span> folder then run:
...
a developer console will show up first for development purposes and that's a known issue.
