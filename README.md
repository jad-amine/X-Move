...
8. To launch the mobile application on an emulator, make sure you have downloaded one Android Studio Andoid AVG and started it. Then navigate to the <span style="color:#ff4d00">"Client"</span> folder then run:
